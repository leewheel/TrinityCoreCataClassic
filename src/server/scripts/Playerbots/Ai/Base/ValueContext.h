...
public:
    ValueContext()
    {
        ...
        creators["custom_glyphs"] = &ValueContext::custom_glyphs;
...
private:
    ...
    static UntypedValue* custom_glyphs(PlayerbotAI* botAI) { return new ManualSetValue<bool>(botAI, false, "custom_glyphs"); }
