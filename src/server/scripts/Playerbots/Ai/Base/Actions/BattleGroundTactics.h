...
//By leewheel 2026-09-06: 移植到TrinityCore-Cata，Cata核心移除BattlegroundAV.h，BG_AV_Nodes枚举在Compat层补齐
...
//By leewheel 2026-08-30: 进战场强制PVP装备+解控饰品检查——老大要求进入战场必须PVP装，解控饰品是必需品
//  查询 bot 当前装备是否包含解控饰品，没有则从 ccBreakTrinketCache 强制装备；
//  同时检查整体装备是否为 PVP 装(韧性)，否则触发 PVP 配装
class BgEnsurePvpGearAction : public Action
{
public:
    BgEnsurePvpGearAction(PlayerbotAI* botAI) : Action(botAI, "bg ensure pvp gear") {}
    bool Execute(Event event) override;
