...
{
public:
    GuidManageAction(PlayerbotAI* botAI, std::string const name = "guild manage", uint16 opcode = CMSG_GUILD_INVITE_BY_NAME)
...
{
public:
    GuildInviteAction(PlayerbotAI* botAI, std::string const name = "guild invite", uint16 opcode = CMSG_GUILD_INVITE_BY_NAME)
...
{
public:
    GuildPromoteAction(PlayerbotAI* botAI, std::string const name = "guild promote", uint16 opcode = CMSG_GUILD_PROMOTE_MEMBER)
        : GuidManageAction(botAI, name, opcode)
    {
    }
...
{
public:
    GuildDemoteAction(PlayerbotAI* botAI, std::string const name = "guild demote", uint16 opcode = CMSG_GUILD_DEMOTE_MEMBER)
        : GuidManageAction(botAI, name, opcode)
    {
    }
...
{
public:
    GuildRemoveAction(PlayerbotAI* botAI, std::string const name = "guild remove", uint16 opcode = CMSG_GUILD_OFFICER_REMOVE_MEMBER)
        : GuidManageAction(botAI, name, opcode)
    {
    }
