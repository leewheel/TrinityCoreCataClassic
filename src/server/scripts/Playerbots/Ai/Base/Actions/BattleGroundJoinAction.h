...
protected:
    ...
    //By leewheel 2026-09-06: 移植到TrinityCore-Cata，队列ID为BattlegroundQueueTypeId结构体
    std::vector<BattlegroundQueueTypeId> bgList;
    std::vector<BattlegroundQueueTypeId> ratedList;
};
