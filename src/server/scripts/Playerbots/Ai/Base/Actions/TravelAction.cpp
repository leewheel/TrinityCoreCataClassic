...
bool TravelAction::Execute(Event /*event*/)
{
    ...
    Cell::VisitGridObjects(bot, searcher, sPlayerbotAIConfig.sightDistance);
...
bool MoveFromDarkPortalAction::Execute(Event /*event*/)
{
    ...
    if (bot->GetTeamId() == TEAM_ALLIANCE)
        //By leewheel 2026-09-03 修复C4305警告：1027.213为double字面量，补f后缀
        return MoveTo(530, -319.261f, 1027.213f, 54.172638f, false, true);
        //End By leewheel

    //By leewheel 2026-09-03 修复C4305警告：1027.947为double字面量，补f后缀
