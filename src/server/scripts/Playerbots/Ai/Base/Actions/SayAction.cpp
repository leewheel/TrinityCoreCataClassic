...
std::string ChatReplyAction::GenerateReplyMessage(Player* bot, std::string& incomingMessage, uint32& guid1, std::string& name)
{
    ...
    for (uint32 i = 0; i < 8; i++)
    {
        ...
        //By leewheel 2026-07-11: TC的ObjectGuid没有(HighGuid, low)构造函数, 用Create<HighGuid::Player>
        if (Player* plr = ObjectAccessor::FindPlayer(ObjectGuid::Create<HighGuid::Player>(guid1)))
        //End By leewheel
        {
            if (plr->isGMChat())
            {
        ...
        default:
        {
            ...
            case 1:
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    msg = "不是，不过 " + word[verb_pos + 1] + " 还会再 " + word[verb_pos + 3] + " 的 %s";
                    break;
                case 3:
                    msg = "恐怕那是在我来之前或者我没注意的时候";
                    break;
    ...
    else if (!found)
    {
        ...
        case 1:
        {
            ...
            case 1:
                ...
                break;
            case 2:
                msg = word[verb_pos ? verb_pos - 1 : verb_pos + 1] + " 还会再 " + word[verb_pos + 1] + " 的 %s";
                break;
            }
            msg = std::regex_replace(msg, std::regex("%s"), name);
            respondsText = msg;
        ...
        case 2:
        {
            ...
            case 1:
                ...
                break;
            case 2:
                msg = "是啊我知道 " + word[verb_pos ? verb_pos - 1 : verb_pos + 1] + " 是个 " + word[verb_pos + 1];
                break;
            }
            msg = std::regex_replace(msg, std::regex("%s"), name);
            respondsText = msg;
        ...
        case 3:
        {
            ...
            case 1:
                ...
                break;
            case 2:
                msg = "你是说 " + word[verb_pos ? verb_pos - 1 : verb_pos + 1] + " 会 " + word[verb_pos + 1] + " " + word[verb_pos + 2] + " 吗 %s？";
                break;
            }
            msg = std::regex_replace(msg, std::regex("%s"), name);
            respondsText = msg;
