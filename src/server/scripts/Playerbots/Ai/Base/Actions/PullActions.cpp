...
bool PullRequestAction::Execute(Event event)
{
    ...
    //By leewheel 2026-08-09: 拉怪请求是明确的开怪指令, 设置pull target放行Attack()的"玩家未攻击保护"
...
{
    //By leewheel 2026-08-04: 非战斗时清除残留引导法术, 否则ReachCombatTo会被channel阻断
...
bool ReachPullAction::isUseful()
{
    ...
    //By leewheel 2026-08-04: 修复残留channel死循环——非战斗时允许Execute执行CastStop后接近拉怪目标
