...
BotCheatMask CheatAction::GetCheatMask(std::string const cheat)
{
    ...
    //By leewheel 2026-08-18: 补充缺失的 "food" 作弊项（否则 .bot cheat +food 永远无法生效）
    if (cheat == "food")
        return BotCheatMask::food;
    //End By leewheel
...
std::string const CheatAction::GetCheatName(BotCheatMask cheatMask)
{
    switch (cheatMask)
    {
        ...
        case BotCheatMask::raid:
            return "raid";
        //By leewheel 2026-08-18: GetCheatName 补充 food（与 GetCheatMask 对应）
        case BotCheatMask::food:
            return "food";
        //End By leewheel
        default:
            return "none";
