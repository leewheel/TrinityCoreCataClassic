...
std::vector<uint32> WorldBuffAction::NeedWorldBuffs(Unit* unit)
{
    ...
    //By leewheel 2026-07-10: TC中GetFactionReactionTo接受(FactionTemplateEntry*, WorldObject*)而非两个FactionTemplateEntry*
    uint32 factionId =
        (Unit::GetFactionReactionTo(humanFaction, unit) >= REP_NEUTRAL) ? 1 : 2;
    //End By leewheel
