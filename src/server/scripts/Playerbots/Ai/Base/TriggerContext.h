/*
 * 移植自 AzerothCore mod-playerbots 模块
 * 适配 TrinityCore API
 * 机器人AI触发器上下文
 */
...
public:
    TriggerContext()
    {
        ...
        //By leewheel 2026-08-29: 引入 NPCBots PVP 战斗触发器
        creators["pvp bot cced"] = &TriggerContext::pvp_bot_cced;
        creators["pvp target casting"] = &TriggerContext::pvp_target_casting;
        creators["pvp target is healer"] = &TriggerContext::pvp_target_is_healer;
        creators["pvp bot low health"] = &TriggerContext::pvp_bot_low_health;
        creators["pvp bot focused"] = &TriggerContext::pvp_bot_focused;
        creators["pvp kite target"] = &TriggerContext::pvp_kite_target;
        creators["pvp enemy player seen"] = &TriggerContext::pvp_enemy_player_seen;
        creators["pvp burst available"] = &TriggerContext::pvp_burst_available;
        creators["pvp need heal"] = &TriggerContext::pvp_need_heal;
        creators["pvp flee"] = &TriggerContext::pvp_flee;
        //By leewheel 2026-08-29: 低血量控制+绷带窗口
        creators["pvp low health cc"] = &TriggerContext::pvp_low_health_cc;
        //End By leewheel
        //By leewheel 2026-08-30: 控场循环闭环——脱战恢复+控制CD就绪重新进场
        creators["pvp cc ready reengage"] = &TriggerContext::pvp_cc_ready_reengage;
        //End By leewheel
        //By leewheel 2026-08-29: 雷霆崖心灵控制伏击玩法
        creators["thunder bluff mind control"] = &TriggerContext::thunder_bluff_mind_control;
        //End By leewheel
        //End By leewheel
        ...
        // By leewheel 2026-08-09: 高频率 LFG 排队触发器(替代 random 7%概率, 快速响应随机本队列)
        creators["lfg queue"] = &TriggerContext::lfg_queue;
        // End By leewheel
...
private:
    ...
    // By leewheel 2026-08-09: 高频率 LFG 排队触发器创建器
    static Trigger* lfg_queue(PlayerbotAI* botAI) { return new LfgJoinTrigger(botAI); }
    // End By leewheel
    ...
    static Trigger* group_heal_occasion(PlayerbotAI* ai) { return new AoeInGroupTrigger(ai, "group heal setting", "almost full"); }
    static Trigger* medium_group_heal_occasion(PlayerbotAI* ai) { return new AoeInGroupTrigger(ai, "medium group heal setting", "medium"); }
    ...
    //By leewheel 2026-08-29: 引入 NPCBots PVP 战斗触发器
    static Trigger* pvp_bot_cced(PlayerbotAI* botAI) { return new PvpBotCcedTrigger(botAI); }
    static Trigger* pvp_target_casting(PlayerbotAI* botAI) { return new PvpTargetCastingTrigger(botAI); }
    static Trigger* pvp_target_is_healer(PlayerbotAI* botAI) { return new PvpTargetIsHealerTrigger(botAI); }
    static Trigger* pvp_bot_low_health(PlayerbotAI* botAI) { return new PvpBotLowHealthTrigger(botAI); }
    static Trigger* pvp_bot_focused(PlayerbotAI* botAI) { return new PvpBotFocusedTrigger(botAI); }
    static Trigger* pvp_kite_target(PlayerbotAI* botAI) { return new PvpKiteTargetTrigger(botAI); }
    static Trigger* pvp_enemy_player_seen(PlayerbotAI* botAI) { return new PvpEnemyPlayerSeenTrigger(botAI); }
    static Trigger* pvp_burst_available(PlayerbotAI* botAI) { return new PvpBurstAvailableTrigger(botAI); }
    static Trigger* pvp_need_heal(PlayerbotAI* botAI) { return new PvpNeedHealTrigger(botAI); }
    static Trigger* pvp_flee(PlayerbotAI* botAI) { return new PvpFleeTrigger(botAI); }
    //By leewheel 2026-08-29: 低血量控制+绷带窗口
    static Trigger* pvp_low_health_cc(PlayerbotAI* botAI) { return new PvpLowHealthCCTrigger(botAI); }
    //End By leewheel
    //By leewheel 2026-08-30: 控场循环闭环——脱战恢复+控制CD就绪重新进场
    static Trigger* pvp_cc_ready_reengage(PlayerbotAI* botAI) { return new PvpReengageTrigger(botAI); }
    //End By leewheel
    //By leewheel 2026-08-29: 雷霆崖心灵控制伏击玩法
    static Trigger* thunder_bluff_mind_control(PlayerbotAI* botAI) { return new ThunderBluffMindControlTrigger(botAI); }
    //End By leewheel
    //End By leewheel
