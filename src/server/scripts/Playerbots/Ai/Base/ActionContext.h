...
//By leewheel 2026-08-21: 移植 brighton-chi b094029a——宠物类动作迁移到PetsAction
...
public:
    ActionContext()
    {
        ...
        //By leewheel 2026-08-29: 引入 NPCBots PVP 战斗动作
        creators["pvp break crowd control"] = &ActionContext::pvp_break_crowd_control;
        creators["pvp interrupt cast"] = &ActionContext::pvp_interrupt_cast;
        creators["pvp kite"] = &ActionContext::pvp_kite;
        creators["pvp flee"] = &ActionContext::pvp_flee;
        //By leewheel 2026-08-29: 低血量PVP打绷带回血
        creators["pvp bandage"] = &ActionContext::pvp_bandage;
        //End By leewheel
        //By leewheel 2026-08-29: 雷霆崖心灵控制伏击玩法
        creators["pvp shadowmeld"] = &ActionContext::pvp_shadowmeld;
        creators["pvp mind control"] = &ActionContext::pvp_mind_control;
        creators["pvp mind control to cliff"] = &ActionContext::pvp_mind_control_to_cliff;
        //End By leewheel
        //End By leewheel
        ...
        //By leewheel 2026-08-30: 进战场强制PVP装备+解控饰品检查(老大要求)
        creators["bg ensure pvp gear"] = &ActionContext::bg_ensure_pvp_gear;
        //End By leewheel
...
private:
    ...
    //By leewheel 2026-08-29: 引入 NPCBots PVP 战斗动作
    static Action* pvp_break_crowd_control(PlayerbotAI* botAI) { return new PvpBreakCrowdControlAction(botAI); }
    static Action* pvp_interrupt_cast(PlayerbotAI* botAI) { return new PvpInterruptCastAction(botAI); }
    static Action* pvp_kite(PlayerbotAI* botAI) { return new PvpKiteAction(botAI); }
    static Action* pvp_flee(PlayerbotAI* botAI) { return new PvpFleeAction(botAI); }
    //By leewheel 2026-08-29: 低血量PVP打绷带回血
    static Action* pvp_bandage(PlayerbotAI* botAI) { return new PvpBandageAction(botAI); }
    //End By leewheel
    //By leewheel 2026-08-29: 雷霆崖心灵控制伏击玩法
    static Action* pvp_shadowmeld(PlayerbotAI* botAI) { return new PvpShadowmeldAction(botAI); }
    static Action* pvp_mind_control(PlayerbotAI* botAI) { return new PvpMindControlAction(botAI); }
    static Action* pvp_mind_control_to_cliff(PlayerbotAI* botAI) { return new PvpMindControlToCliffAction(botAI); }
    //End By leewheel
    //End By leewheel
    ...
    //By leewheel 2026-08-30: 进战场强制PVP装备+解控饰品检查
    static Action* bg_ensure_pvp_gear(PlayerbotAI* botAI) { return new BgEnsurePvpGearAction(botAI); }
    //End By leewheel
