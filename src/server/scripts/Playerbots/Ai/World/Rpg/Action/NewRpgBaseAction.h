...
#include "QuestDef.h"
#include "TravelMgr.h"
//By leewheel 2026-07-09: TC需要显式包含G3D/Vector2.h
...
protected:
    ...
    //By leewheel 2026-07-20: 默认距离从INTERACTION_DISTANCE(5.0f)改为3.0f，TC的CanInteractWithQuestGiver检查combatReach+4.0f≈4.0f
    bool MoveWorldObjectTo(ObjectGuid guid, float distance = 3.0f);
    //End By leewheel
