...
public:
    BearDruidStrategyActionNodeFactory()
    {
        ...
        creators["maul"] = &maul;
        creators["bash"] = &bash;
        //By leewheel 2026-08-01: 按上游(5640dc38)修正——德鲁伊不存在名为"swipe"的技能，
        //熊形态统一使用"swipe (bear)"
        creators["swipe (bear)"] = &swipe_bear;
        //End By leewheel
        creators["lacerate"] = &lacerate;
        // Empty ActionNode needed to register as taunt spell
        // 需要一个空 ActionNode 来将嘲讽（growl）注册为 "taunt spell"
...
private:
    ...
    //By leewheel 2026-08-01: 按上游(5640dc38)修正，swipe改为swipe_bear并指向"swipe (bear)"
