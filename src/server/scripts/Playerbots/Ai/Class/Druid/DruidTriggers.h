...
public:
    ...
    std::vector<uint32> GetFallbackSpellIds() const override { return { 12536, 16246, 16870, 67210 }; }
};
...
public:
    ...
    std::vector<uint32> GetFallbackSpellIds() const override { return { 69369 }; }
};
...
public:
    ...
    bool IsActive() override
    {
        ...
        for (uint32 spellId : GetFallbackSpellIds())
            if (bot->HasAura(spellId)) return true;
        return false;
    }
    std::vector<uint32> GetFallbackSpellIds() const override { return { 16188, 17116, 29274 }; }
};
...
public:
    ...
    std::vector<uint32> GetFallbackSpellIds() const override { return { 48517 }; }
};
...
public:
    ...
    std::vector<uint32> GetFallbackSpellIds() const override { return { 48518 }; }
};
