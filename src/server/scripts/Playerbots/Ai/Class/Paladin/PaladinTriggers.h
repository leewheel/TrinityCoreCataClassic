...
//By leewheel 2026-08-06: 添加IsActive重写,用spell ID fallback防止locale匹配失败导致trigger误触发
...
public:
    ...
    std::vector<uint32> GetFallbackSpellIds() const override { return { 53486, 53488, 53489, 59578 }; }
};
