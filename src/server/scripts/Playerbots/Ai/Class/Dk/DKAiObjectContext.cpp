...
public:
    DeathKnightTriggerFactoryInternal()
    {
        ...
        //By leewheel 2026-07-30: 三个姿态检测 trigger 注册,给 Blood/Frost/Unholy 三个 DK 天赋策略用
        creators["no blood presence"] = &DeathKnightTriggerFactoryInternal::no_blood_presence;
        creators["no frost presence"] = &DeathKnightTriggerFactoryInternal::no_frost_presence;
        creators["no unholy presence"] = &DeathKnightTriggerFactoryInternal::no_unholy_presence;
        //End By leewheel
    }
...
private:
    ...
    //By leewheel 2026-07-30: 三个姿态检测 trigger 工厂方法
    static Trigger* no_blood_presence(PlayerbotAI* botAI) { return new NoBloodPresenceTrigger(botAI); }
    static Trigger* no_frost_presence(PlayerbotAI* botAI) { return new NoFrostPresenceTrigger(botAI); }
    static Trigger* no_unholy_presence(PlayerbotAI* botAI) { return new NoUnholyPresenceTrigger(botAI); }
    //End By leewheel
};
