...
//By leewheel 2026-08-17 修复: 原 10H=74280/25H=74281 在 3.4.3 DB2 中不存在(8-15 抄错 ID,
//官方英雄模式复用 10N/25N 的施放 ID, 阳台用 72296), 导致 SpellScript Validate 失败
//启动报 "spell_icc_malleable_goo spell (Id: 74280/74281) does not exist"。删除无效定义。
