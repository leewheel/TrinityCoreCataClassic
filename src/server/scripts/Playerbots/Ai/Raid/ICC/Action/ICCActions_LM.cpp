/*
 * 鍐板啝鍫″瀿 - 鐜涙礇鍔犲皵棰嗕富锛圠ord Marrowgar锛夋満鍣ㄤ汉鍔ㄤ綔瀹炵幇
 * 澶勭悊楠ㄥ埡鐐瑰悕銆佹棆椋庢柀韬查棯銆佽繎鎴樺垎鏁ｇ瓑鏈哄埗
 */
...
{
    // All difficulty variants 鈥?AzerothCore spawns a different entry per difficulty mode.
