...
bool IccValithriaHealAction::Execute(Event /*event*/)
{
    ...
    if (!bot->HasAura(SPELL_DREAM_STATE))
    {
        ...
        bot->SetSpeed(MOVE_RUN, NORMAL_SPEED); //By leewheel 2026-08-14: TC SetSpeed浠?鍙傛暟
        bot->SetSpeed(MOVE_WALK, NORMAL_SPEED); //By leewheel 2026-08-14: TC SetSpeed浠?鍙傛暟
        bot->SetSpeed(MOVE_FLIGHT, NORMAL_SPEED); //By leewheel 2026-08-14: TC SetSpeed浠?鍙傛暟
    }
...
bool IccValithriaDreamCloudAction::Execute(Event /*event*/)
{
    ...
    bot->SetSpeed(MOVE_RUN, 2.0f); //By leewheel 2026-08-14: TC SetSpeed浠?鍙傛暟
    bot->SetSpeed(MOVE_WALK, 2.0f); //By leewheel 2026-08-14: TC SetSpeed浠?鍙傛暟
    bot->SetSpeed(MOVE_FLIGHT, 2.0f); //By leewheel 2026-08-14: TC SetSpeed浠?鍙傛暟
