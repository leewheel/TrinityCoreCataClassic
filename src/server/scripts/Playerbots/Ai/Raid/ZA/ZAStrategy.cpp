...
void RaidZulAmanStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    //By leewheel 2026-09-04: 上游14413ee2——旋风逃跑优先级从 EMERGENCY+6 提到 +1(与冰霜陷阱逃跑同级)
    ...
    //By leewheel 2026-09-04: 上游14413ee2——旋风逃跑优先级从 EMERGENCY+6 提到 +1
...
void RaidZulAmanStrategy::InitMultipliers(std::vector<Multiplier*>& multipliers)
{
    ...
    //By leewheel 2026-09-04: 上游14413ee2——新增冰霜陷阱驻留乘数
