...
//By leewheel 2026-08-23: 合并 the-lab(MC Improvements #2573)——补充缺失 include
...
{
    //By leewheel 2026-08-23: 合入 the-lab(MC Improvements #2573)完整逻辑; boss 按项目规则使用 entry(#11988 = Golemagg the Incinerator)
