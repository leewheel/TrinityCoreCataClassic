...
/*By leewheel 2026-08-18: 对齐 brighton-chi the-lab HEAD(e92a52db)——
  移植 fde72295/47abcff2(压缩: 误导/主坦站位动作收敛为通用 HyjalMisdirectBossToMainTankAction/
  HyjalMainTankPositionBossAction, 参数化Boss名/点位/到达距离/撤退血量)、
  33f67223/7f293f95/ab50f6a1(命名与 Archimonde 体系)。*/
