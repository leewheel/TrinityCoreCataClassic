...
public:
    ...
    {
        //By leewheel 2026-08-14: Uld reset action
        creators["ulduar reset encounter states"] = &RaidUlduarActionContext::ulduar_reset_encounter_states;
        //End By leewheel
...
private:
    //By leewheel 2026-08-14: Uld reset action
    static Action* ulduar_reset_encounter_states(PlayerbotAI* ai) { return new UlduarResetEncounterStatesAction(ai); }
    //End By leewheel
