...
//By leewheel 2026-08-14: Uld reset——脱战清理Razorscale等全局状态
class UlduarResetEncounterStatesAction : public Action
{
public:
    UlduarResetEncounterStatesAction(PlayerbotAI* botAI)
        : Action(botAI, "ulduar reset encounter states") {}
