...
public:
    RaidUlduarTriggerContext()
    {
        ...
        creators["ulduar bot is not in combat"] = &RaidUlduarTriggerContext::ulduar_bot_is_not_in_combat;
        //End By leewheel
...
private:
    //By leewheel 2026-08-14: Uld reset trigger
    static Trigger* ulduar_bot_is_not_in_combat(PlayerbotAI* ai) { return new UlduarBotIsNotInCombatTrigger(ai); }
    //End By leewheel
