...
private:
    ...
    //By leewheel 2026-09-04: 上游4f9815d1——GetFlamePatches 移到 TKHelpers; IsPathSafe 增加 start 参
...
private:
    //By leewheel 2026-08-21: 移植 brighton-chi 615c78d2——RangedBotsDisperse 改传阶段数字,不再依赖 boss_kaelthas
