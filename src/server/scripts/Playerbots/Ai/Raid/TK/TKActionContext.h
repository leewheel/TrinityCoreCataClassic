...
public:
    RaidTempestKeepActionContext()
    {
        ...
        //By leewheel 2026-08-24: 移植 brighton-chi c9a1a088——清除卡住坠落flag
        //By leewheel 2026-09-04 修复: 删除重复的creator注册(21-22行残留)
        ...
        //By leewheel 2026-08-21: 移植 brighton-chi 2eaa83f3——索兰莉安恐惧守卫动作并入通用动作
        //End By leewheel
        ...
        //By leewheel 2026-08-21: 移植 brighton-chi 2eaa83f3——萨古纳尔恐惧守卫动作并入通用动作
        //End By leewheel
...
private:
    ...
    //By leewheel 2026-08-21: 移植 brighton-chi 2eaa83f3——索兰莉安恐惧守卫工厂已移除(并入通用动作)
    //End By leewheel
    ...
    //By leewheel 2026-08-21: 移植 brighton-chi 2eaa83f3——萨古纳尔恐惧守卫工厂已移除(并入通用动作)
    //End By leewheel
