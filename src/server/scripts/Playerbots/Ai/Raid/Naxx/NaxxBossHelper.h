...
public:
    ...
    bool BeforeDecimate()
    {
        ...
        // Fallback to name for custom spell data.
        //By leewheel 2026-07-27: 使用多locale辅助函数
        const char* spellName = GetSpellNameBestLocaleWithCache(info->Id, info->SpellName);
        return spellName && *spellName && botAI->EqualLowercaseName(spellName, "decimate");
        //End By leewheel
    }
