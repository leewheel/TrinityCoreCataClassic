...
public:
    GrobbulusRotateAction(PlayerbotAI* botAI)
        //By leewheel 2026-09-03 修复C4305警告：M_PI为double字面量，参数为float，显式转换
        : RotateAroundTheCenterPointAction(botAI, "rotate grobbulus", 3281.23f, -3310.38f, 35.0f, 8, true, float(M_PI)) {}
    //End By leewheel
