 ...
 *
 * 作者: leewheel
 * 移植来源: AC [SSCTriggers.h] 移植适配 TC 框架
 * 业务对标: AC mod-playerbots src/Ai/Raid/SSC/SSCTriggers.h
 * By leewheel 2026-09-04: 上游d86674ef/c31f2280——构造函数压缩为单参风格;
 *   NoEncounterInProgress 保留 1000ms 节流(上游067fab59已并入);
 *   删除 LeotherasTheBlindBossIsInactiveTrigger(上游随 Spellbinder 标记逻辑一并移除)
 * End By leewheel
 */
