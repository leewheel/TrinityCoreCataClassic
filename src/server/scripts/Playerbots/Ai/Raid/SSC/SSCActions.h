 ...
 *
 * 作者: leewheel
 * 移植来源: AC [SSCActions.h] 移植适配 TC 框架
 * 业务对标: AC mod-playerbots src/Ai/Raid/SSC/SSCActions.h
 * By leewheel 2026-09-04: 上游d86674ef/c31f2280——构造函数压缩为单参风格(名字内联);
 *   删除 LeotherasTheBlindTargetSpellbindersAction(上游随 GetFirstAliveUnitByEntry 一并删除);
 *   AvoidToxicSpores 私有函数签名 const 位置规范化; PassTheTaintedCore 私有函数声明折行
 * End By leewheel
 */
