...
public:
    RaidSwpActionContext()
    {
        ...
        //By leewheel 2026-08-21: 移植 brighton-chi b49a9cc2——卡雷苟斯误导动作(通用误导类)
...
private:
    ...
    //By leewheel 2026-08-21: 移植 brighton-chi b49a9cc2——误导动作boss名用entry(卡雷苟斯龙形态)
    ...
    // Brutallus
    //By leewheel 2026-08-21: 移植 brighton-chi b49a9cc2——误导动作合并为通用类(boss名用entry)
