...
//By leewheel 2026-09-04: 上游1e110a5f——新增Blaze缓存常量(位置提前); MAX_DPS_HP_PERCENT改名EREDAR_TWINS_MAX_DPS_HP_PERCENT(避免跨副本撞名)
...
//By leewheel 2026-08-21: 移植 brighton-chi cbfc7ea0——搜索双子烈焰位置(仅存坐标, 不存对象指针)
...
//By leewheel 2026-08-21: 移植 brighton-chi 3c8d60e0——DPS等待窗口打开(由触发器调用)
...
//By leewheel 2026-08-14: 清理双子Blaze跟踪(底层map在匿名namespace，供reset action全实例清理)
