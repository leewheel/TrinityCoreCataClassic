...
//By leewheel 2026-09-04: 上游1e110a5f——触及常量改用SWPSharedConstants.h全局常量
...
bool TryGetMuruDarknessActiveState(Player* bot, Unit* muru)
{
    ...
    if (Aura* darkness = muru->GetAura(Id(SwpSpells::SPELL_DARKNESS)))
    {
        ...
        //By leewheel 2026-09-04: 上游1e110a5f——跟随改名 MURU_DARKNESS_PRE_EFFECT_MS/MURU_DARKNESS_AURA_MS
    ...
    //By leewheel 2026-08-27: 对齐 the-lab cc4219a3——移除 DARKNESS_RUN_BACK_ALLOWANCE_MS 提前量, 严格按到期时间判定
...
Unit* FindMuruFuryMageToSpellsteal(PlayerbotAI* botAI)
{
    ...
    //By leewheel 2026-09-04: 上游1e110a5f——改用全局 RANGED_ABILITY_REACH
    return SelectNearestQualifying(
