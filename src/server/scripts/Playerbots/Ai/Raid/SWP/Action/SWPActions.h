...
public:
    SunwellPlateauMisdirectBossToMainTankAction(
        PlayerbotAI* botAI, std::string const& actionName, std::string const& bossName)
        : Action(botAI, actionName), _bossName(bossName) {}
    bool Execute(Event event) override;
...
//By leewheel 2026-08-18: 移植 brighton-chi the-lab 7f293f95(重命名一系列团本动作/触发器)
...
public:
    ...
    bool Execute(Event event) override;
    //By leewheel 2026-08-27: 对齐 the-lab 1e0caf61——重置远位到达标记(供战斗重置用)
...
private:
    //By leewheel 2026-08-22: 引入 brighton-chi the-lab 新提交(9e8e7718..70b60954)——目标选择改为就近+切换余量
...
//By leewheel 2026-08-22: 引入 brighton-chi the-lab 新提交(9e8e7718..70b60954)——奴隶虚空小怪动作基类调整
