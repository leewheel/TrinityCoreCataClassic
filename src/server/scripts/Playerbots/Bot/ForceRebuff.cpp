...
{
    //By leewheel 2026-08-23: AC 用 GetGlobalCooldownMgr(), TC 用 GetSpellHistory()->HasGlobalCooldown()
    return bot && lastGcdSpell && bot->GetSpellHistory()->HasGlobalCooldown(lastGcdSpell);
    //End By leewheel
}
