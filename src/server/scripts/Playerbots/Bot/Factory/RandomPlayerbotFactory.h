...
//By leewheel 2026-08-23: 合并 the-lab(#2637 Arena refactor) —— 需要 ArenaTeam/Battleground 完整类型
#include "ArenaTeam.h"
...
//By leewheel 2026-07-11: TC的ArenaType是enum(无基类型,默认int), 前向声明必须匹配
enum ArenaType : int;
//End By leewheel
